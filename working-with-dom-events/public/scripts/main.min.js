...
'use strict';var router=require('lr-client-router'),renderer=require('lr-client-renderer'),core=require('lr-core'),road=core('client').extension('router',router,!0).extension('renderer',renderer,!0).middleware({'events.navigation':require('../middleware/events/navigation')});require('./road')(road);

},{"../middleware/events/navigation":12,"./road":6,"lr-client-renderer":1,"lr-client-router":2,"lr-core":3}],6:[function(require,module,exports){
