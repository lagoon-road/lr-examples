...
},{"core-js/fn/regexp/escape":4,"core-js/shim":297,"regenerator-runtime/runtime":302}],2:[function(require,module,exports){
...
},{"check-types":2}],301:[function(require,module,exports){
...
},{"./is-function":304,"./is-object":305,"./request-base":306,"./response-base":307,"./should-retry":308,"component-emitter":3}],304:[function(require,module,exports){
/**
...
var road = require('lr-main')('client').extension('router', router, true).extension('renderer', renderer, true).extension('httpClient', httpClient).middleware({
...
},{"../extensions/httpClient":312,"../middleware/events/home":320,"../middleware/events/navigation":321,"./road":311,"babel-polyfill":1,"lr-client-renderer":298,"lr-client-router":299,"lr-main":300}],311:[function(require,module,exports){
'use strict';
...
module.exports = function (road) {
  ...
  }).where('webserver').run('*', 'statics').run('*', 'layouts.default').where('client').run('*', 'events.navigation', 'navigationLoaded').run('/', 'events.home', 'homeLoaded').where('webserver', 'client').run('updateValue', 'log', 'updateType').run('*', 'components.navigation.loaded').run('/', 'components.home.loaded').run('/', 'components.home.loading', 'data').run('/', 'data.home', 'data').run('/', 'components.home.loaded', 'data').run('/about', 'components.about.loading').run('/about', 'data.about').run('/about', 'components.about.loaded').error('components.about.error').where('webserver').done('response');
};

},{"../middleware/components/about/loaded":313,"../middleware/components/about/loading":314,"../middleware/components/home/loaded":315,"../middleware/components/home/loading":316,"../middleware/components/navigation/loaded":317,"../middleware/data/about":318,"../middleware/data/home":319}],312:[function(require,module,exports){
'use strict';
