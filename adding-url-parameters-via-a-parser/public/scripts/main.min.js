...
},{"../middleware/events/navigation":13,"./road":7,"lr-client-renderer":2,"lr-client-router":3,"lr-main":4}],7:[function(require,module,exports){
'use strict';var debug=require('../extensions/debug'),parser=require('lr-url-parser')();module.exports=function(a){a.parser(parser).extension('debug',debug).middleware({debug:require('../middleware/debug'),'components.navigation':require('../middleware/components/navigation'),'components.home':require('../middleware/components/home'),'components.contact':require('../middleware/components/contact')}).where('webserver').run('*','debug').run('*','statics').run('*','layouts.default').where('client').run('nav','events.navigation','domReady').where('webserver','client').run('*','components.navigation').run('/','components.home').run('/params/:id','components.home').run('/contact','components.contact').where('webserver').done('response')};

},{"../extensions/debug":8,"../middleware/components/contact":9,"../middleware/components/home":10,"../middleware/components/navigation":11,"../middleware/debug":12,"lr-url-parser":5}],8:[function(require,module,exports){
...
'use strict';module.exports=function(a,b,c){b.extensions.debug('Rendering component home: '+c.url),b.extensions.debug('URL parameters: '+JSON.stringify(b.parameters)),b.extensions.renderer.render('<h1>This is the homepage</h1>','.content'),a()};
