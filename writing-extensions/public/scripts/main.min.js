...
},{"../extensions/httpClient":312,"../middleware/events/home":321,"../middleware/events/navigation":322,"./road":311,"babel-polyfill":5,"lr-client-renderer":1,"lr-client-router":2,"lr-core":3}],311:[function(require,module,exports){
'use strict';
...
module.exports = function (road) {
  ...
  }).where('webserver').run('*', 'statics').run('*', 'layouts.default').where('client').run('*', 'events.navigation', 'navigationLoaded').run('/', 'events.home', 'homeLoaded').where('webserver', 'client').run('*', 'components.navigation.loaded').run('/', 'components.home.loaded').run('/', 'components.home.loading', 'data').run('/', 'data.home', 'data').run('/', 'components.home.loaded', 'data').run('/error', 'fail').run('/about', 'components.about.loading').run('/about', 'data.about').run('/about', 'components.about.loaded').error('components.about.error').where('webserver').done('response');
};

},{"../middleware/components/about/error":313,"../middleware/components/about/loaded":314,"../middleware/components/about/loading":315,"../middleware/components/home/loaded":316,"../middleware/components/home/loading":317,"../middleware/components/navigation/loaded":318,"../middleware/data/about":319,"../middleware/data/home":320,"../middleware/fail":323}],312:[function(require,module,exports){
'use strict';
