...
},{"check-types":4}],4:[function(require,module,exports){
...
},{"core-js/fn/regexp/escape":7,"core-js/shim":300,"regenerator-runtime/runtime":302}],6:[function(require,module,exports){
...
},{"./is-function":304,"./is-object":305,"./request-base":306,"./response-base":307,"./should-retry":308,"component-emitter":6}],304:[function(require,module,exports){
/**
...
},{"./is-object":305}],305:[function(require,module,exports){
/**
...
},{"./is-object":305}],307:[function(require,module,exports){
...
var router = require('lr-client-router');
var renderer = require('lr-client-renderer');
var httpClient = require('../extensions/httpClient')('http://eol.org/api/');
var core = require('lr-core');
var road = core('client').extension('router', router, true).extension('renderer', renderer, true).extension('httpClient', httpClient).middleware({
...
},{"../extensions/httpClient":312,"../middleware/events/home":322,"../middleware/events/navigation":323,"./road":311,"babel-polyfill":5,"lr-client-renderer":1,"lr-client-router":2,"lr-core":3}],311:[function(require,module,exports){
'use strict';

module.exports = function (road) {
  road.extension('updater', require('../extensions/updater'), true).middleware({
  ...
  }).where('webserver').run('*', 'statics').run('*', 'layouts.default').where('client').run('*', 'events.navigation', 'navigationLoaded').run('/', 'events.home', 'homeLoaded').where('webserver', 'client').run('updateValue', 'log', 'updateType').run('*', 'components.navigation.loaded').run('/', 'components.home.loaded').run('/', 'components.home.loading', 'data').run('/', 'data.home', 'data').run('/', 'components.home.loaded', 'data').run('/error', 'fail').run('/about', 'components.about.loading').run('/about', 'data.about').run('/about', 'components.about.loaded').error('components.about.error').where('webserver').done('response');
};

},{"../extensions/updater":313,"../middleware/components/about/error":314,"../middleware/components/about/loaded":315,"../middleware/components/about/loading":316,"../middleware/components/home/loaded":317,"../middleware/components/home/loading":318,"../middleware/components/navigation/loaded":319,"../middleware/data/about":320,"../middleware/data/home":321,"../middleware/fail":324,"../middleware/log":325}],312:[function(require,module,exports){
'use strict';
...
},{"superagent":303}],313:[function(require,module,exports){
'use strict';
...
module.exports = function (next, relay) {
...
module.exports = function (next, relay, request) {
...
module.exports = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(next, relay) {
    var path, data, about, state;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            path = 'pages/1.0.json?id=1048601&details=true';
            _context.next = 3;
            return relay.extensions.httpClient.get(path);

          case 3:
            data = _context.sent;
            about = JSON.parse(data.text).dataObjects.shift().description;
            state = Object.assign({}, relay.state ? relay.state : {}, { about: about });
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            data = _context.sent;
            home = JSON.parse(data.text).dataObjects.shift().description;
            state = Object.assign({}, relay.state ? relay.state : {}, { home: home });
...
module.exports = function (next, relay) {
  document.querySelector('.customExtension').addEventListener('click', function (event) {
    event.preventDefault();
...
module.exports = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(next, relay, request) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
