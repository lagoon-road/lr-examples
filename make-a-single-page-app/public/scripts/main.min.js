...
'use strict';var router=require('lr-client-router'),renderer=require('lr-client-renderer'),road=require('lr-main')('client').extension('router',router,!0).extension('renderer',renderer,!0);require('./road')(road);

},{"./road":6,"lr-client-renderer":2,"lr-client-router":3,"lr-main":4}],6:[function(require,module,exports){
