...
'use strict';var router=require('lr-client-router'),renderer=require('lr-client-renderer'),core=require('lr-core'),road=core('client').extension('router',router,!0).extension('renderer',renderer,!0);require('./road')(road);

},{"./road":6,"lr-client-renderer":1,"lr-client-router":2,"lr-core":3}],6:[function(require,module,exports){
